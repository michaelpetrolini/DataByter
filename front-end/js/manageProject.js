...
(function () {
  ...
  async function saveProject() {
    const inp = document.querySelector('input[id=name]');
    ...
    if (pName) {
      ...
      const pType = document.querySelector('input[name=type]').value;
      const fields = document.querySelectorAll('.field-left');
      const labels = document.querySelectorAll('.label-left');
      const model = new RestProjectModel(pName, description, pType, fields, labels, client);
      await model.create();
